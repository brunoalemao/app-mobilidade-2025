              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="number"
                      value={newCategory.basePrice?.toString() || "0"}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewCategory(prev => ({ ...prev, basePrice: parseFloat(e.target.value) || 0 }))}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Preço por KM (após 3km)
                  </label>
                  <div className="relative">
                    <span className="absolute left-3 top-2">R$</span>
                    <input
                      type="number"
                      value={newCategory.pricePerKm?.toString() || "0"}
                      onChange={(e) => setNewCategory(prev => ({ ...prev, pricePerKm: parseFloat(e.target.value) || 0 }))}
                      className="input pl-10 w-full"
                      placeholder="0.00"
                      step="0.01"
                      min="0"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="number"
                      value={newCategory.pricePerMinute?.toString() || "0"}
                      onChange={(e) => setNewCategory(prev => ({ ...prev, pricePerMinute: parseFloat(e.target.value) || 0 }))}
                      className="input pl-10 w-full"
                      placeholder="0.00"
                      step="0.01"
                      min="0"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      <input
                        type="number"
                        value={newCategory.dynamicPricing?.rainMultiplier?.toString() || "1.2"}
                        onChange={(e) => setNewCategory(prev => ({
                          ...prev,
                          dynamicPricing: {
                            ...prev.dynamicPricing!,
                            rainMultiplier: parseFloat(e.target.value) || 1.2
                          }
                        }))}
                        className="input w-full"
                        placeholder="1.2"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        type="number"
                        value={newCategory.dynamicPricing?.peakHoursMultiplier?.toString() || "1.5"}
                        onChange={(e) => setNewCategory(prev => ({
                          ...prev,
                          dynamicPricing: {
                            ...prev.dynamicPricing!,
                            peakHoursMultiplier: parseFloat(e.target.value) || 1.5
                          }
                        }))}
                        className="input w-full"
                        placeholder="1.5"
