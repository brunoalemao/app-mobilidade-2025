...
import { isMobileDevice, requestNotificationPermission, registerNotificationServiceWorker } from './utils/notifications';
    ...
    const initializeNotifications = async () => {
      try {
        ...
        if (registration) {
          ...
          console.log('⚠️ Service worker não pôde ser registrado');
        }
      } catch (error) {
